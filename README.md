# Michael's Developer Environment
...
- Use Mason in nvim (`:MasonInstall <language-server>`) to install other language servers like clangd, pyright, marksman, texlab, gopls
